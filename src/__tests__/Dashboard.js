...
describe("Given I am connected as an Admin", () => {
  describe("When I am on Dashboard page, there are bills, and there is one pending", () => {
    ...
    test("Then, filteredBills by pending status should return 1 bill", () => {
      //Ensuite, les factures filtrées par statut en attente doivent renvoyer 1 facture
  ...
  describe("When I am on Dashboard page and I click on arrow", () => {
    // Quand je suis sur la page Tableau de bord et que je clique sur la flèche
    test("Then, tickets list should be unfolding, and cards should appear", async () => {
      // Ensuite, la liste des billets devrait se dérouler et les cartes devraient apparaître
  ...
  describe("When I am on Dashboard page and I click 2 times on edit icon of a card", () => {
    // Lorsque je suis sur la page Tableau de bord et que je clique 2 fois sur l'icône d'édition d'une carte
    test("Then, big bill Icon should Appear", () => {
      // Ensuite, l'icône de la grosse facture devrait apparaître
      const onNavigate = (pathname) => {
        document.body.innerHTML = ROUTES({ pathname });
      };
...
describe("Given I am connected as Admin and I am on Dashboard page and I clicked on a bill", () => {
  // Étant donné que je suis connecté en tant qu'administrateur et que je suis sur la page du tableau de bord et que j'ai cliqué sur une facture
